...
public class Indicator {
    ...
    private com.codepipes.ting.pageindicatorview.draw.data.RtlMode rtlMode;
    ...
    @NonNull
    public com.codepipes.ting.pageindicatorview.draw.data.RtlMode getRtlMode() {
        if (rtlMode == null) {
            rtlMode = com.codepipes.ting.pageindicatorview.draw.data.RtlMode.Off;
        }
        return rtlMode;
    }
