...
package com.codepipes.ting.ratings;
...
import static com.codepipes.ting.ratings.RatingUtils.getRoundedBarDrawable;
import static com.codepipes.ting.ratings.RatingUtils.getRoundedBarGradientDrawable;
...
public class RatingReviews extends FrameLayout {
    ...
    public RatingReviews(Context mCtx, AttributeSet attrs) {
        ...
        mBarDimension = a.getDimensionPixelSize(R.styleable.RatingReviews_width,
                (int) RatingUtils.convertDpToPixel(20, mCtx));
        mBarColor = a.getColor(R.styleable.RatingReviews_color, RatingUtils.DEFAULT_BAR_COLOR);
        mBarTextSize = (int) RatingUtils.convertPixelsToDp(
                a.getDimensionPixelSize(R.styleable.RatingReviews_text_size,
                        (int) RatingUtils.convertDpToPixel(15, mCtx)), mCtx);
        mBarTextColor = a.getColor(R.styleable.RatingReviews_text_color, RatingUtils.DEFAULT_BAR_TEXT_COLOR);
        ...
        mBarSpaces = a.getDimensionPixelSize(R.styleable.RatingReviews_spaces,
                (int) RatingUtils.convertDpToPixel(RatingUtils.DEFAULT_BAR_SPACE, mCtx));
    ...
    private void createBar(int dimension, final Bar bar) {
        ...
        switch (mStyle) {
            case 1:
                styleLayout = R.layout.rating_bar;
                break;
            case 2:
                styleLayout = R.layout.rating_bar_two;
                break;
            default:
                styleLayout = R.layout.rating_bar;
                break;
