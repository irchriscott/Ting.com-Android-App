...
class RestaurantSpecification : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            val upArrow = ContextCompat.getDrawable(this@RestaurantSpecification, R.drawable.abc_ic_ab_back_material)
            upArrow!!.setColorFilter(ContextCompat.getColor(this@RestaurantSpecification, R.color.colorPrimary), PorterDuff.Mode.SRC_ATOP)
