...
class TodayPromotions : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            val upArrow = ContextCompat.getDrawable(this@TodayPromotions, R.drawable.abc_ic_ab_back_material)
            upArrow!!.setColorFilter(ContextCompat.getColor(this@TodayPromotions, R.color.colorPrimary), PorterDuff.Mode.SRC_ATOP)
        ...
        refresh_promotions.setColorSchemeColors(resources.getColor(R.color.colorPrimary), resources.getColor(R.color.colorAccentMain), resources.getColor(R.color.colorPrimaryDark), resources.getColor(R.color.colorAccentMain))
