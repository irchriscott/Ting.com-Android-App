...
import kotlinx.android.synthetic.main.row_cuisine_menu.view.*
...
class CuisineMenusAdapter (private val menus: MutableSet<RestaurantMenu>) : RecyclerView.Adapter<CuisineMenusViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, type: Int): CuisineMenusViewHolder {
        ...
        val row = layoutInflater.inflate(R.layout.row_cuisine_menu, parent, false)
        return CuisineMenusViewHolder(row)
    }
...
class CuisineMenusViewHolder (val view: View, var menu: RestaurantMenu? = null) : RecyclerView.ViewHolder(view) {}