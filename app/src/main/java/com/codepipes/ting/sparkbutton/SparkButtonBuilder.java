...
import com.codepipes.ting.sparkbutton.SparkButton;
import com.codepipes.ting.sparkbutton.helpers.Utils;


public class SparkButtonBuilder {
    private com.codepipes.ting.sparkbutton.SparkButton sparkButton;
    private Context context;

    public SparkButtonBuilder(Context context) {
        this.context = context;
        sparkButton = new com.codepipes.ting.sparkbutton.SparkButton(context);
    }
