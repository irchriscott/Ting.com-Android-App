...
import com.codepipes.ting.imageeditor.editimage.interfaces.OnGestureControl;
import com.codepipes.ting.imageeditor.editimage.interfaces.OnMainBitmapChangeListener;
import com.codepipes.ting.imageeditor.editimage.interfaces.OnMultiTouchListener;
import com.codepipes.ting.imageeditor.editimage.interfaces.OnPhotoEditorListener;
import com.codepipes.ting.imageeditor.editimage.layout.ZoomLayout;
...
public class AddTextFragment extends BaseEditFragment implements OnPhotoEditorListener, OnClickListener, OnMainBitmapChangeListener, OnMultiTouchListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mainView = inflater.inflate(R.layout.image_editor_fragment_edit_image_add_text, container, false);
        return mainView;
    }
    ...
    private View getTextStickerLayout() {
        ...
        View rootView = layoutInflater.inflate(R.layout.image_editor_view_text_sticker_item, null);
