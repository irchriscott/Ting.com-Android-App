package com.codepipes.ting.imageeditor.editimage.ui;
...
public class ColorPicker extends Dialog implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            setContentView(R.layout.image_editor_layout_color_picker);
        } else { setContentView(R.layout.image_editor_layout_color_picker_old_android); }
    ...
    private void updateColorView(String s) {
        if (s.matches("-?[0-9a-fA-F]+")) {
            ...
            codHex.setError(c.getResources().getText(R.string.colorpicker_errHex));
        }
    }
