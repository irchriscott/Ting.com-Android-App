...
class RestaurantProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            val upArrow = ContextCompat.getDrawable(this@RestaurantProfile,
                R.drawable.abc_ic_ab_back_material
            )
            upArrow!!.setColorFilter(ContextCompat.getColor(this@RestaurantProfile,
                R.color.colorWhite
    ...
    private fun showBranch(){
        ...
        val adapter =
            RestaurantProfileViewPagerAdapter(
