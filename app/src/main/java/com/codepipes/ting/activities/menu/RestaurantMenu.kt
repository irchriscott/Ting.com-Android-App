...
class RestaurantMenu : AppCompatActivity(), RatingDialogListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            val upArrow = ContextCompat.getDrawable(this@RestaurantMenu,
                R.drawable.abc_ic_ab_back_material
            )
            upArrow!!.setColorFilter(ContextCompat.getColor(this@RestaurantMenu,
        ...
        refresh_menu.setColorSchemeColors(resources.getColor(R.color.colorPrimary), resources.getColor(
